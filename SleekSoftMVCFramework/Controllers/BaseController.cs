...
namespace SleekSoftMVCFramework.Controllers
{
    public class BaseController : Controller
    {
        ...
        public static ApplicationUser applicationUserInformation(int UserId)
        {
        ...
        protected void CreateViewBagAccountTypeProductParams()
        {
            ViewBag.IsUpdate = false;
            ViewBag.ModalTitle = "Add";
            ViewBag.ButtonAction = "Save";
            ViewBag.PostAction = "CreateAccountProduct";
        ...
        protected void EditViewBagAccountTypeProductParams()
        {
            ViewBag.IsUpdate = true;
            ViewBag.ModalTitle = "Edit";
            ViewBag.ButtonAction = "Update";
            ViewBag.PostAction = "EditAccountProduct";
        }
