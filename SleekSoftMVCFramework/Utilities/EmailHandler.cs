    ...
    public class EmailHandler
    {
        ...
        public static bool Send(MailMessage message)
        {
            try
            {
                ...
                string sendgridUsername = ConfigurationManager.AppSettings["SendGridUserName"].ToString();
                string sendgridPwd = ConfigurationManager.AppSettings["SendGridPassword"].ToString();
                ...
                System.Net.NetworkCredential credentials = new System.Net.NetworkCredential(sendgridUsername, sendgridPwd);
