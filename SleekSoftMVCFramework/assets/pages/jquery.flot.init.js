...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var pcolors = ['#4bd396', '#f5707a','#C29738'];
		...
		var colors = ['#C29738', '#4bd396', "#f5707a", "#f9c851"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#0F0455']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		this.createLineGraph("#line-chart-alt", line_ticks, ["#f5707a", "#C29738"], line_data);
	},
