...
!function($) {
    ...
    MorrisCharts.prototype.init = function() {
        ...
        this.createLineChart('morris-line-example', $data, 'y', ['a', 'b'], ['Series A', 'Series B'],['0.1'],['#ffffff'],['#999999'], ['#C29738', '#4bd396']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#0F0455', '#ff9800', "#f5707a"]);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#4bd396', '#ebeff2', "#0F0455"]);
    },
    //init
