        ...
        : EntityTypeConfiguration<ApplicationUser>
    {
        public ApplicationUserTableConfig()
        {
           ...
           // Property(u => u.Id).IsRequired().HasColumnName("Id");
            ...
            this.Property(m => m.FirstName).IsOptional();
            this.Property(m => m.MiddleName).IsOptional();
            this.Property(m => m.LastName).IsOptional();
            ...
            this.Property(m => m.Gender).IsRequired();


            this.Property(m => m.PicturePath).IsOptional();
           ...
           // HasRequired(u => u.ChurchMember).WithRequiredPrincipal(u => u.User).WillCascadeOnDelete();
